...
def speech_to_text():
    ...
    try:
        ...
        messagebox.showerror(message="Enter a valid duration (integer)")
        return
    ...
    with sr.Microphone() as mic:
        ...
        try:
            ...
            messagebox.showwarning(message="No speech detected")
        except sr.RequestError as e:
            messagebox.showerror(message=f"Error with the speech recognition service: {e}")
